...
export declare class Track {
    ...
    public lastPlayed: number | null;
    public resolve(riffy: Riffy): Promise<Track>;
    public markPlayed(emitter?: EventEmitter): void;
    public emitEnd(emitter?: EventEmitter): void;
}
...
export declare class Queue extends Array<Track> {
    constructor(maxSize?: number, emitter?: EventEmitter);
    get size(): number;
...
export declare class Plugin {
    ...
    static listLoaded(): Plugin[];
    static getLoaded(name: string): Plugin | null;
    public setConfig(key: string, value: any): void;
    public getConfig(key: string): any;
    load(riffy: Riffy): void;
    unload(riffy: Riffy): void;
    reload(riffy: Riffy): void;
...
export declare class Node extends EventEmitter {
    ...
    public getDiagnostics(): object;
    public setUnhealthy(value: boolean): void;
    public autoFailover(nodeMap: Map<string, Node>): Promise<void>;
    /**
...
export declare class Filters {
    ...
    public setBassboost(enabled: boolean, options?: object): this;
    public setSlowmode(enabled: boolean, options?: object): this;
    public setNightcore(enabled: boolean, options?: object): this;
    public setVaporwave(enabled: boolean, options?: object): this;
    public set8D(enabled: boolean, options?: object): this;
    public setCustom(filters: object): this;
